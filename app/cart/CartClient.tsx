...
export default function CartClient() {
  ...
  const validate = (): string => {
    ...
    if (form.messenger === "telegram" && !form.telegramNick.trim())
      return "Введите никнейм в Telegram";
    ...
    if (!agreed) return "Необходимо согласие с обработкой персональных данных";
    return "";
  };
